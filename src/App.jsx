...
import { DefaultView, Key, Phrase, RemoveWallet } from ".";
...
export default function FamilyDrawer() {
  ...
  return (
    <>
      <button
        className="fixed top-1/2 left-1/2 antialiased cursor-pointer -translate-y-1/2 -translate-x-1/2 h-[44px] rounded-full border border-gray-200 bg-white px-4 py-2 font-medium text-black transition-colors hover:bg-[#F9F9F8] focus-visible:shadow-focus-ring-button md:font-medium"
